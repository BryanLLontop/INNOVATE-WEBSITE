            ...
            {filteredMenus.map((fila, index) => (
                <Col xl={12} lg={12} md={12} xs={12} key={index}>
                        <Card className='mb-3'>
                            ...
                            <div className="text-center border-bottom" key={fila.id}>
                                <h1 className="display-4 fw-bold">{fila.titulo}</h1>
                                ...
                                <div className="overflow-hidden"  style={{ maxHeight: `40vh` }}>
                                    ...
                                    <img src={fila.imagen} className="img-fluid border rounded-3 shadow-lg mb-4" alt="Example image" width="700" height="auto" loading="lazy"/>
                                    </div>
                                </div>
                            </div>
                            </Card.Body>
